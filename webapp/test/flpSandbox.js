		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "API Kanye West",
									"targetURL": "#comkaykykanyeapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkaykykanyeapplication-display": {
								"semanticObject": "comkaykykanyeapplication",
								"action": "display",
								"description": "Kanye Phrases",
								"title": "API Kanye West",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kayky.kanyeapplication",
									"url": sap.ui.require.toUrl("com/kayky/kanyeapplication")
								}
							}
						}
					}
